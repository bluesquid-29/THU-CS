...
// 標題區
#align(center)[
  #text(size: 22pt, weight: "bold")[26/05/04 Ch13 作業——class] \
  #text(size: 16pt, weight: "regular")[Problem 9, 10]
]
...
//     ]
    #figure(
      image("13-9_problem.jpg", width: 65%),
    )
  ],
  [
    (b) 以指向物件的*指標*為引數，*印出*銷售額較高的產品：
    ```cpp
  ...
  [
    #figure(
      image("13-9_terminal.png", width: 55%),
    )
  ],
  "13-9_homework.cpp",
)
