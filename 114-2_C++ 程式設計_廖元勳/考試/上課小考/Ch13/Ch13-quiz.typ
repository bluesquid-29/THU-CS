...
// 標題區
#align(center)[
  #text(size: 22pt, weight: "bold")[26/05/11 Ch13小考——class 進階] \
...
#exam_item(
  "1. 交換成績",
  [
    定義一個Student學生類別，該類別內有三個公開層級的屬性分別記錄國文、英語和數學成績。再定義一個可將兩Student物件的成績互換的函式，執行結果如下：
...
//         gutter: 10pt,        // Space between cells
//         [
//           ```cpp
...
//     ]
  ...
  [
    #figure(
      image("terminal.png", width: 45%),
    )
  ],
  [
    下列分別附上 pointer 與 reference 的實踐方法
  ],
  ("13_(pointer).cpp", "13_(reference).cpp")
)
